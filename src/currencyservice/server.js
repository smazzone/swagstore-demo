...
if(process.env.ENABLE_TRACING == "1") {
  ...
  const provider = new NodeTracerProvider({
    resource: new Resource({
      ...
      [SemanticResourceAttributes.SERVICE_VERSION]: process.env.OTEL_SERVICE_VERSION || '1.0',      
    }),
  });

  logger.info("SERVICE_NAME: " + SemanticResourceAttributes.SERVICE_NAME)
  logger.info("SERVICE_VERSION: " + SemanticResourceAttributes.SERVICE_VERSION)
